                    ...
                    case 15: 
                        ...
                        if(reta(point2,point3,line)){
                            ...
                            if(reta(point4,point,line) && um == true){
                                ...
                                texto.x = 750;
                                texto.setText([
                                    'Marca um ponto da reta perpendicular\n a ' + letra1 + letra2 +' que passa por '+ letra4
                                ]); 
                                sgm = true; 
                                certas = 1; 
                            }
                    ...
                    case 17: 
                        ...
                        if(reta(point2,point3,line)){
                            ...
                            if(reta(point4,point,line) && um == true){
                                ...
                                texto.setText([
                                    'Marca um ponto da reta paralela\n a ' + letra1 + letra2 +' que passa por '+ letra3
                                ]); 
                                sgm = true; 
                                certas = 1; 
                            }
                                        ...
                                        if (sgm && !cinco){ 
                                            ...
                                            if(sgm&& !cinco && !seis){
                                                ...
                                                if(aceitaMidle){
                                                    ...
                                                    texto.setText([
                                                        'Traça a reta SUPORTE da semirreta \n|' + letra1 + letra5
                                                    ]); 
...
function getPretendedLine (level,ponto1,ponto2){
    ...
    Phaser.Geom.Line.SetToAngle(otherLine,x,y,angleInverse,1000);

    var otherLine2=new Phaser.Geom.Line(); 
    Phaser.Geom.Line.SetToAngle(otherLine2,x1,y1,angle,1000);
    ...
    switch (level){
        case 1: 
            ...
            var pontos = pretended.getPoints(50);
...
function generateExtraPoint(pontos,quantos){
    ...
    if(point!=null){
        a1 = point.x;
        b1=point.y;        
        while((a>700||b>450 || b<200 ||a==x || a==x1 || b==y || b==y1 || a==a1 || a==b1 || dist(a,b,point2.x,point2.y)<=50 || dist(a,b,point3.x,point3.y)<=50 || dist(a,b,point.x,point.y)<=50||(b<=teste.y+50 && b>=teste2.y-50))&&continua){
            a = Math.random()*(800 - 300) + 300;
            b = Math.random()*(600 - 300) + 300;
            iterations += 1; 
            if(iterations>200){
...
function textoLevel(level){
    ...
    switch (level){
        ...
        case 8: 
            return 'Traça a reta que passa por ';
        case 9: 
            return ['Traça a semirreta com origem ','\n e que passa por '];
        case 10: 
            return ['Traça a semirreta com origem ','\n e que passa por '];
        case 11: 
            return ['Traça a semirreta com origem ','\n e que passa por '];
        case 12: 
            return ['Traça a semirreta OPOSTA à \nsemirreta com origem em ',' \ne que passa por '];
        case 13: 
            return 'Traça a reta que passa por ';
        case 14: 
            return 'Traça a reta que passa por ';
